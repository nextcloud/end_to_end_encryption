OC.L10N.register(
    ...
    "You are not the owner of the share" : "Sie sind nicht der Besitzer dieser Freigabe",
    ...
    "This is the final warning: Do you really want to reset your keys?" : "Dies ist die letzte Warnung: Wollen Sie Ihre Schlüssel zurücksetzen?",
    "Cancel" : "Abbrechen",
    ...
    "Decrypting {file}" : "Entschlüssele {file}",
    "An error occurred while decrypting the file. Please try downloading the file again." : "Beim Entschlüsseln der Datei ist ein Fehler aufgetreten. Bitte erneut versuchen, die Datei herunterzuladen.",
    "Pending file drop migrations" : "Ausstehende Dateiablage-Migrationen",
    "There are pending file drop migrations that need to be completed. Do you want to complete them now?" : "Es stehen Dateiablage-Migrationen aus, die abgeschlossen werden müssen. Sollen diese jetzt fertiggestellt werden?",
    "Migrate now" : "Jetzt migrieren",
    "Migrate later" : "Später migrieren",
    "Migrating file drop entries, please do not close this tab…" : "Dateiablage-Einträge werden migriert. Bitte diese Registerkarte nicht schließen …",
    "An error occurred while migrating one file drop entry. Please try again later." : "Fehler beim Migrieren eines Dateiablage-Eintrags. Bitte später noch einmal versuchen.",
    "There are pending tasks that need to be completed. Are you sure you want to leave?" : "Es gibt ausstehende Aufgaben, die erledigt werden müssen. Wirklich verlassen?",
