OC.L10N.register(
    ...
    "Can not decode userlist" : "Не могу да декодирам листу корисника",
    ...
    "Can't read metadata" : "Не могу да читам метаподатке",
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state. Use only with test data, never in production!" : "Обезбеђује неопходну крајњу тачку да омогући шифровање са краја на крај. Шифровање са краја на крај је још увек у алфа стању. Користите га само на тест подацима, никад у продукцији!",
    "internal error" : "Интерна грешка",
