OC.L10N.register(
    ...
    "Any still connected device might cause problems after deleting the keys, so it is better to disconnect and reconnect the devices again." : "Hâlâ bağlı olan herhangi bir aygıt, anahtarları sildikten sonra sorunlara neden olabilir, bu nedenle aygıtların bağlantısını kesip yeniden bağlamak daha iyidir.",
    "Delete existing encrypted files" : "Mevcut şifreli dosyaları sil",
    "This is the final warning: Do you really want to reset your keys?" : "Bu son uyarıdır: Anahtarlarınızı gerçekten sıfırlamak istiyor musunuz?",
