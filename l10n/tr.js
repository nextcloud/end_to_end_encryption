OC.L10N.register(
    ...
    "End to end encryption" : "Uçtan uca şifreleme",
    "Reset end to end encryption" : "Uçtan uca şifrelemeyi sıfırla",
    "Please read carefully before resetting your end-to-end encryption keys" : "Uçtan uca şifreleme anahtarlarınızı sıfırlamadan önce lütfen dikkatlice okuyunuz",
    "Once your end to end encryption keys are reset, all files stored in your encrypted folder will be inaccessible" : "Uçtan uca şifreleme anahtarlarınız sıfırlandığında, şifrelenmiş klasörünüzde depolanan tüm dosyalar erişilemez olacak",
    "You should only reset your end to end encryption keys if you lost your secure key words (mnemonic)" : "Uçtan uca şifreleme anahtarlarınızı yalnızca güvenli anahtar kelimelerinizi (anımsatıcı) kaybettiyseniz sıfırlamanız gerekir",
    "Check on all connected devices if you can retrieve your mnemonic" : "Anımsatıcınızı alabiliyorsanız, bağlı tüm cihazları kontrol edin",
    "End to end encryption is currently enabled and correctly setup." : "Uçtan uca şifreleme şu anda etkin ve doğru şekilde ayarlanmış.",
    "End to end encryption is currently disabled. You can set it up with the {productName} clients." : "Uçtan uca şifreleme şu anda devre dışı. {productName} istemcileriyle ayarlayabilirsiniz.",
    "End to end keys reset" : "Uçtan uca anahtarları sıfırlama",
    "Unable to reset end to end encryption" : "Uçtan uca şifreleme sıfırlanamıyor"
},
