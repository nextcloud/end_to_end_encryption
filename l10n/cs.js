OC.L10N.register(
    ...
    {
    "Not allowed to get private key" : "Nepovoleno získat soukromý klíč",
    ...
    "Could not parse the CSR, please make sure to submit a valid CSR" : "CSR nebylo možné zpracovat. Ověřte že jste poskytli platné CSR",
    "Common name (CN) does not match the share token" : "Běžné jméno (CN) se neshoduje s tokenem sdílení",
    "You are not the owner of the share" : "Nejste vlastníky tohoto sdílení",
    ...
    "Enable client-side end-to-end encryption for your most sensitive files, ensuring complete privacy with zero-knowledge security." : "Zapněte šifrování mezi koncovými body (implementované na straně klienta) pro své nejcitlivější soubory, což zajistí naprosté soukromí zabezpečením typu „nulová znalost“.",
    ...
    "Download and decrypt" : "Stáhnout a rozšifrovat",
    "Download and decrypt all selected files." : "Stáhnout a rozšifrovat všechny označené soubory.",
    "Downloading …" : "Stahování …",
    "Failed downloads" : "Nezdařená stahování",
    "Download" : "Stáhnout",
    ...
    "Close" : "Zavřít",
    "Copy file drop link" : "Zkopírovat odkaz na příjem souboru",
    "Delete file drop" : "Smazat okamžité zaslání souboru",
