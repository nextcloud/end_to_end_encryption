OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state, don't use this in production and only with test data!" : "Zapewnia ustawienie niezbędnego punktu końcowego, aby umożliwić szyfrowanie end-to-end. Szyfrowanie end-to-end jest nadal w stanie alfa, nie używaj go w produkcji i tylko z danymi testowymi!"
},
