OC.L10N.register(
    ...
    {
    "This is someone else's private key" : "Ez valaki más privát kulcsa",
    "Could not find the private key of the user %s" : "%s felhasználó privát kulcsa nem található",
    "Internal error" : "Belső hiba",
    "You are not allowed to delete this private key" : "Nincs jogosultságod törölni ezt a privát kulcsot",
    "Could not find the private key belonging to the user %s" : "%s felhasználóhoz tartozó privát kulcs nem található",
    "internal error" : "belső hiba",
