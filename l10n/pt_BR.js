OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state. Use only with test data, never in production!" : "Fornece o ponto de extremidade necessário para ativar a criptografia de ponta a ponta. A criptografia de ponta a ponta ainda está no estado alfa. Use apenas com dados de teste, nunca em produção!",
    "internal error" : "erro interno",
