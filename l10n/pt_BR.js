OC.L10N.register(
    ...
    "button-vue--text-only" : "botão-vue--somente-texto",
    "button-vue--wide" : "botão-vue-largo",
    "button-vue--tabbed" : "botão-vue--tabbed",
    "_avatardiv__user-status_::_avatardiv__user-status--_" : ["avatardiv__user-status","avatardiv__user-status--","avatardiv__user-status--"],
    "_focusable_::_#_" : ["focusable","#","#"],
    "_icon-confirm_::_submit_" : ["icon-confirm","enviar","enviar"],
    "_mention-bubble__title_::_heading_" : ["mention-bubble__title","cabeçalho","cabeçalho"],
    "_mention-bubble__select_::_none_" : ["mention-bubble__select","nenhum","nenhum"],
    "_mention-bubble_::_mention-bubble--primary_" : ["menção-bolha","menção-bolha--primário","menção-bolha--primário"],
    "_trigger_::_trigger_" : ["acionar","acionar","acionar"],
    "End to End Encryption" : "Criptografia Ponto a Ponto",
    "When at least one group is selected, only people of the listed groups can use the end to end encryption app." : "Quando pelo menos um grupo é selecionado, apenas as pessoas dos grupos listados podem usar o aplicativo de criptografia de ponta a ponta.",
    ...
    "Reset end to end encryption" : "Redefinir criptografia de ponta a ponta",
    "Once your end to end encryption keys are reset, all files stored in your encrypted folder will be inaccessible" : "Depois que suas chaves de criptografia de ponta a ponta forem redefinidas, todos os arquivos armazenados em sua pasta criptografada ficarão inacessíveis",
    "You should only reset your end to end encryption keys if you lost your secure key words (mnemonic)" : "Você só deve redefinir suas chaves de criptografia de ponta a ponta se perder suas palavras-chave seguras (mnemônicos)",
    "Check on all connected devices if you can retrieve your mnemonic" : "Verifique em todos os dispositivos conectados se você pode recuperar seu mnemônico",
    "error" : "erro",
    "Cancel" : "Cancelar",
    "Confirm" : "Confirmar",
