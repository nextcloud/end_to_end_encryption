OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state. Use only with test data, never in production!" : "Poskytuje koncový bod nevyhnutný pre šifrovane po celej dĺžke spojenia. Šifrovanie po celej dĺžke spojenia je stále vo vývojovom štádiu alfa. Používajte iba s testovacími údajmi a nikdy v produkčnom prostredí!",
    "internal error" : "interná chyba",
