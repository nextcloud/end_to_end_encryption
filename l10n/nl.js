OC.L10N.register(
    ...
    {
    "You are not allowed to access this private key" : "Je bent niet bevoegd om deze privésleutel te openen",
    "Private key for user %s not found" : "Private sleutel voor gebruiker %s niet gevonden",
    ...
    "You are not allowed to edit the file, make sure to lock it first and send the right token" : "Je mag het bestand niet bewerken. Zet het eerst op slot en stuur dan het juiste token.",
    "Meta data file doesn't exist" : "Metadatabestand bestaat niet.",
