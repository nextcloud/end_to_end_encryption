OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state, don't use this in production and only with test data!" : "Fornece o \"endpoint\" necessário para ativar a encriptação ponto-a-ponto. esta ainda está no estado alfa, não utilize isto na produção, utilize apenas com dados de teste!"
},
