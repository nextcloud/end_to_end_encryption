OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state, don't use this in production and only with test data!" : "Fournit le point de terminaison nécessaire pour activer le chiffrement de bout en bout. Le cryptage de bout en bout est toujours en mode alpha, ne l'utilisez pas en production et uniquement avec des données de test !"
},
