OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption.\n\n**Notice:** E2EE is currently not compatible to be used together with server-side encryption" : "Tillhandahåller den nödvändiga slutpunkten för att möjliggöra totalsträckskryptering.\n\n**OBS:** E2EE är för närvarande inte kompatibel för att användas tillsammans med server-side-kryptering",
    "Limit to groups" : "Begränsa till grupper",
    "When at least one group is selected, only people of the listed groups can use the End-to-End encryption app." : "När minst en grupp är vald kan endast personer i de listade grupperna använda appen för totalsträckskryptering.",
    "Limit app usage to groups." : "Begränsa appanvändning till grupper.",
    "Save" : "Spara",
    "Saved groups" : "Sparade grupper",
    "End-to-end encryption" : "Totalsträckskryptering",
    "Reset end-to-end encryption" : "Återställ totalsträckskryptering",
    ...
    "Check on all connected devices if you can retrieve your mnemonic." : "Kontrollera på alla anslutna enheter om du kan hämta dina nyckelord.",
