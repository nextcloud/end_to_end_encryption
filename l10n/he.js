OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state. Use only with test data, never in production!" : "מספקת את נקודת הגישה הנחוצה לטובת הצפנה מקצה לקצה. תכונה זו עדיין במצב בתולי, יש להשתמש רק עם נתוני דמה, אף פעם לא בסביבה היומיומית (production)!",
    "internal error" : "שגיאה פנימית",
