OC.L10N.register(
    ...
    "Provides the necessary endpoint to enable end-to-end encryption. End-to-end encryption is still in alpha state. Use only with test data, never in production!" : "Предоставляет необходимую конечную точку для обеспечения сквозного шифрования. Сквозное шифрование все ещё находится в альфа-состоянии, не используйте его для данных, представляющих ценность.",
