...
import { decryptFile, replacePlaceholderInPropfind } from './webDavProxy.ts'
...
test('Correctly decrypt file on GET', async () => {
	const responseBody = base64ToBuffer('O13d2Y5O7qYDTerGfZyRwHKWcEktQQiJBm5rWzY=')
	console.log(responseBody)

	const fileContent = await decryptFile(new Response(responseBody), metadataInfo.files.ad3b12554e0d4364854ae3e21b170152)
