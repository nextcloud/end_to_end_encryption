...
const dontShowAgain = ref(storage.getItem('suppress_browser_warning') === 'true')
watchEffect(() => {
	if (dontShowAgain.value) {
		confirmToggle.value = true
		storage.setItem('suppress_browser_warning', 'true')
	} else {
		storage.removeItem('suppress_browser_warning')
	}
})
