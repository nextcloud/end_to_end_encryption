...
class KeyController extends OCSController {
	 ...
	 * @NoAdminRequired
	 *
	 * @param $shareToken - optional share token to delete a private key associated with a share
	 ...
	 * @param $shareToken - optional share token to set a private key associated with a share
	 ...
	 * @param $shareToken - optional share token to create a public key associated with a share
	 *
	 ...
	 * @NoAdminRequired
	 *
	 * @param $shareToken - optional share token to delete a public key associated with a share
	 * @return DataResponse<Http::STATUS_OK, list<empty>, array{}>
	 *
	 * @throws OCSForbiddenException Not allowed to delete public key
	 * @throws OCSBadRequestException Internal error
